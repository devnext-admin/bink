...
import { StaffAvatar } from '@bink/shared/components/ui/avatar';
...
import { getBookings } from '@bink/shared/lib/data';
import { sized } from '@bink/shared/lib/image';
import { formatDuration, formatPrice, formatTime, weekdayName } from '@bink/shared/lib/format';
import { useI18n } from '@bink/shared/lib/i18n';
import { getLocalReviews, ratingWithLocal, submitReview } from '@bink/shared/lib/ops';
import { colors, font, maxContentWidth, radius, shadow } from '@bink/shared/lib/theme';
import type { Review, Service, Venue } from '@bink/shared/lib/types';
