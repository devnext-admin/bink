...
#ifndef EASCLIENT_SWIFT_H
#define EASCLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EASClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSUUID;
SWIFT_CLASS("_TtC9EASClient11EASClientID")
@interface EASClientID : NSObject
+ (NSUUID * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
