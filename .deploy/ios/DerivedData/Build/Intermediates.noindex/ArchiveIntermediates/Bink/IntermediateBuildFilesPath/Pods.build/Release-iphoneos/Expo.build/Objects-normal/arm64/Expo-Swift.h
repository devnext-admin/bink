...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Expo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Expo26AppDelegatesLoaderDelegate")
@interface AppDelegatesLoaderDelegate : NSObject
/// Gets and registers AppDelegate subscribers.
+ (void)registerAppDelegateSubscribers:(id <EXAppDelegateSubscriberProtocol> _Nonnull)legacySubscriber;
...
@property (nonatomic, strong) RCTReactNativeFactory * _Nullable factory;
...
/// For callsites to customize network fetch functionalities like having custom <code>URLSessionConfiguration</code>.
SWIFT_CLASS_NAMED("ExpoFetchCustomExtension")
@interface EXFetchCustomExtension : NSObject
+ (void)setCustomURLSessionConfigurationProvider:(NSURLSessionConfigurationProvider _Nullable)provider;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol RCTReactNativeFactoryDelegate;
SWIFT_CLASS("_TtC4Expo22ExpoReactNativeFactory")
@interface ExpoReactNativeFactory : RCTReactNativeFactory
- (nonnull instancetype)initWithDelegate:(id <RCTReactNativeFactoryDelegate> _Nonnull)delegate OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDelegate:(id <RCTReactNativeFactoryDelegate> _Nonnull)delegate releaseLevel:(RCTReleaseLevel)releaseLevel SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC4Expo30ExpoReactNativeFactoryDelegate")
@interface ExpoReactNativeFactoryDelegate : RCTDefaultReactNativeFactoryDelegate
