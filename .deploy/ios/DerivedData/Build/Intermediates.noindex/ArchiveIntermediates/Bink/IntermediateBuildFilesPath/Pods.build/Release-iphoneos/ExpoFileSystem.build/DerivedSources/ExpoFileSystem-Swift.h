...
#ifndef EXPOFILESYSTEM_SWIFT_H
#define EXPOFILESYSTEM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpoFileSystem",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#import <ExpoFileSystem/ExpoFileSystem.h>
...
@class NSString;
@class UIApplication;
SWIFT_CLASS("_TtC14ExpoFileSystem34FileSystemBackgroundSessionHandler")
@interface FileSystemBackgroundSessionHandler : EXBaseAppDelegateSubscriber <EXSessionHandler, EXAppDelegateSubscriberProtocol>
- (void)invokeCompletionHandlerForSessionIdentifier:(NSString * _Nonnull)identifier;
