...
#ifndef EXUPDATESINTERFACE_SWIFT_H
#define EXUPDATESINTERFACE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EXUpdatesInterface",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("UpdatesControllerRegistry")
@interface EXUpdatesControllerRegistry : NSObject
@property (nonatomic, weak) id <EXUpdatesExternalInterface> _Nullable controller;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) EXUpdatesControllerRegistry * _Nonnull sharedInstance;)
+ (EXUpdatesControllerRegistry * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL_NAMED("UpdatesExternalInterface")
@protocol EXUpdatesExternalInterface
...
SWIFT_PROTOCOL_NAMED("UpdatesExternalInterfaceDelegate")
@protocol EXUpdatesExternalInterfaceDelegate
