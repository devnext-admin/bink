...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Bink",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Bink11AppDelegate")
@interface AppDelegate : EXExpoAppDelegate
...
SWIFT_CLASS_NAMED("ExpoModulesProvider")
@interface ExpoModulesProvider : ModulesProvider
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class RCTBridge;
SWIFT_CLASS("_TtC4Bink19ReactNativeDelegate")
