...
#ifndef EXPOFONT_SWIFT_H
#define EXPOFONT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpoFont",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@interface UIFont (SWIFT_EXTENSION(ExpoFont))
/// Returns an array of font names for the specified family name or its alias.
+ (NSArray<NSString *> * _Nonnull)_expo_fontNamesForFamilyName:(NSString * _Nonnull)familyName SWIFT_WARN_UNUSED_RESULT;
@end
