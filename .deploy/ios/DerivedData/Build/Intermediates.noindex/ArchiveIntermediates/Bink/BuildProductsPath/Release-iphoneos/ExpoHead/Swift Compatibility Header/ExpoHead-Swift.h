...
#ifndef EXPOHEAD_SWIFT_H
#define EXPOHEAD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpoHead",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ExpoHead29ExpoHeadAppDelegateSubscriber")
@interface ExpoHeadAppDelegateSubscriber : EXBaseAppDelegateSubscriber <EXAppDelegateSubscriberProtocol>
